...
import { WebformWebhookConfigComponent } from './pages/webform-webhook-config/webform-webhook-config.component';
...
const routes: Routes = [
  {
    ...
    children: [
      ...
      {
         path: 'webhook-config',
         component: WebformWebhookConfigComponent
      }
    ],
  },
  {
